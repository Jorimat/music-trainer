...
# Input
fileOut = '/tmp/score-16-16-medium-nbar.musicxml'
bars = 4
beats = 4
beat_type = 4
divisions = 4
...
'''
        <note default-x="94.23" default-y="-15.00"><pitch><step>C</step><octave>3</octave></pitch><duration>1</duration><voice>1</voice><type>16th</type><stem>up</stem><beam number="1">begin</beam><beam number="2">begin</beam></note>
        <note><rest/><duration>1</duration><voice>1</voice><type>16th</type></note>   
        <note default-x="94.23" default-y="-15.00"><pitch><step>C</step><octave>3</octave></pitch><duration>1</duration><voice>1</voice><type>16th</type><stem>up</stem></note>
        <note><rest/><duration>1</duration><voice>1</voice><type>16th</type></note>''',  
...
sel = []
while len(sel) < bars:
    sel_ = list(np.random.choice(range(len(pattern)), 2, replace=False))
    if not sel_ in sel:
        sel.append(sel_)
